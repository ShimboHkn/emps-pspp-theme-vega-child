...
if($jobcatID || $jobtypeID || $jobarea || $jobclassID || $jobdate || $s) :
?>
<div id="searchoption" class="search-option">
<p><span class="search-option-head">検索条件：</span>
<?php
	serach_opt_by_ID('教科', 'job_listing_category', $jobcatID);
	serach_opt_by_ID('雇用形態', 'job_listing_type', $jobtypeID);
	serach_opt_by_Key('勤務地', $jobarea);
	serach_opt_by_ID('学校種別', 'job_listing_class', $jobclassID);
