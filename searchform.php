...
?>
<option value="" disabled class="disabled"><?php echo $area[0]; ?></option>
<?php
	$prefs = $area[1];
	foreach($prefs as $pref) :
?>
<option value="<?php echo $pref[1]; ?>">&nbsp;&nbsp;<?php echo $pref[0]; ?></option>
<?php
	endforeach;
endforeach;
